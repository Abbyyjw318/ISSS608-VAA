...
This exercise shows how to use appropriate R methods to plot analytical maps.
...
### Visualising distribution of functional and total water point
...
tmap_arrange(p2, p1, asp = 2, nrow = 1)
```
