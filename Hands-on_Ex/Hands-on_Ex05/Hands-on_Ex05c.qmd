...
Transforming the data frame into a matrix The code chunk below will be used to transform wh data frame into a data matrix.
...
To plot a cluster heatmap, just have to use the default as shown in the code chunk below.
