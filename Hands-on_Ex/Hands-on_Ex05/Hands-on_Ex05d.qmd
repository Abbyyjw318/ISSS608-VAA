...
This exercise focuses on using parallel coordinates plots to visualise and analyse multivariate numerical data. Parallel coordinates plots are suitable for comparing multiple variables simultaneously and identifying patterns or clusters in high-dimensional data.

The following packages are used:

-   GGally: ggparcoord() for statistical parallel coordinates plots

-   parallelPlot: for interactive parallel coordinates plots
...
The basic parallel coordinates failed to reveal any meaning understanding of the World Happiness measures, by using a collection of arguments provided by ggparcoord() can makeover the plot.
